...
import {
  ...
  CreditCard, Lock, Infinity, Upload, FileText
} from 'lucide-react';
...
const Pricing = () => {
  ...
  const plans = [
    ...
    {
      name: 'Pro',
      price: { monthly: 39000, yearly: 399000 }, // oylik 39,000 so'm, yillik 399,000 so'm
      originalPrice: { monthly: 49000, yearly: 492600 }, // original narx, chegirma ko'rsatish uchun
            ...
            >
              ...
              <div className="p-8">
                ...
                <button
                  ...
                  disabled={plan.name === 'Bepul'} // Free plan is disabled
                  onClick={() => {
            ...
            >
              ...
              <div className="p-8">
                <div className="text-center mb-6">
                  ...
                  {billingCycle === 'yearly' && plan.price.monthly !== 0 && plan.price.monthly !== 'Custom' && (
                    <p className="text-sm text-green-600 dark:text-green-400 mt-1">
                      Save {new Intl.NumberFormat('uz-UZ').format(plan.price.monthly * 12 * 0.2)} so'm yearly
                    </p>
                  )}
                </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Hayotingizni o'zgartirishga tayyormisiz?
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            InFast AI bilan o'z mahsuldorligi va hayot boshqaruvini allaqachon yangilagan millionlab foydalanuvchilarga qo'shiling.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              ...
              onClick={() => window.open('https://t.me/mister_yakubov', '_blank')}
            >
              Sotish bilan bog'lanish
            </button>
          </div>
          <p className="text-sm text-blue-200 mt-4">
            30 kunlik pul qaytarish kafolati • Istalgan vaqtda bekor qilish • Sozlash to'lovlari yo'q
          </p>
        </div>
      </div>
