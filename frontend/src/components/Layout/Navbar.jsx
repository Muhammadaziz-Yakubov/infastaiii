...
import { Bell, Search, X, Clock, CheckSquare, User, MessageSquare, Loader, Menu, CheckCircle, Trash2, Moon, Sun, Settings, LogOut, ChevronDown, Target, Trophy, Wallet, TrendingUp, TrendingDown } from 'lucide-react';
                      ...
                      <div className="border-b border-gray-100 dark:border-gray-700">
                        <div className="px-4 py-3 bg-gray-50 dark:bg-gray-900">
                          <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 flex items-center gap-2">
                            ...
                            Maqsadlar ({searchResults.goals.length})
                          </h3>
                        </div>
                        <div>
                      ...
                      <div className="border-b border-gray-100 dark:border-gray-700">
                        <div className="px-4 py-3 bg-gray-50 dark:bg-gray-900">
                          <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 flex items-center gap-2">
                            ...
                            Challengelar ({searchResults.challenges.length})
                          </h3>
                        </div>
                        <div>
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <div className="flex items-center gap-3 mt-1">
                                  <span className="text-xs text-orange-600 dark:text-orange-400">
                                    🔥 {challenge.participantData?.currentStreak || 0} streak
                                  </span>
                      ...
                      <div className="border-b border-gray-100 dark:border-gray-700">
                        <div className="px-4 py-3 bg-gray-50 dark:bg-gray-900">
                          <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 flex items-center gap-2">
                            ...
                            Moliya ({searchResults.transactions.length})
                          </h3>
                        </div>
                        <div>
